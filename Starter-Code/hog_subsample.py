...
sys.path.append(R'D:\\Github\\CarND-Vehicle-Detection-and-Tracking\\Starter-Code')
...
dist_pickle = pickle.load(open("dist_pickle.pickle", "rb"))
svc = dist_pickle["svc"]
...
img = cv2.imread(R'D:\Github\CarND-Vehicle-Detection-and-Tracking\Starter-Code\car_test.png')
img1 = mpimg.imread(R'D:\Github\CarND-Vehicle-Detection-and-Tracking\Starter-Code\car_test.png')
img1[0]
img2 = mpimg.imread(R'D:\Github\CarND-Vehicle-Detection-and-Tracking\Starter-Code\test_img.jpg')
img2[0]
...
img_tosearch = img[100:ystop,:,:]
ctrans_tosearch = convert_color(img_tosearch, conv='BGR2YCrCb')
plt.imshow(cv2.cvtColor(ctrans_tosearch,cv2.COLOR_BGR2RGB))
